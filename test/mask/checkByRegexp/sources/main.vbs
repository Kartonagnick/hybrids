...
function main()
  ...
  test 22, deep, f_path, "main.*"     , "*.vbs", false
                         
  test 23, deep, d_path, "windows"    , "11"   , true
  test 24, deep, d_path, "windo?s"    , "11"   , true
  test 25, deep, d_path, "win*"       , ""     , true
  test 26, deep, d_path, "win*"       , "w*"   , false
  test 27, deep, d_path, "*"          , "w*"   , false

  if gMY_TEST = true then
   'echo deep, "[SUCCESS] checkByRegexp"
  else
