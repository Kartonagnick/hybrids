...
rem --- local/hybrids                        [mask/masksToRegexp/test-[vbs].bat]
rem [2024-02-23][08:20:00] 001 Kartonagnick PRE
rem ============================================================================
rem ============================================================================
...
::set "eDEBUG=ON"
  set "eDIR=%~dp0_ready"
  set "title=mask/masksToRegexp"
  call :setDepth
  call :show [%title%] run... 0.0.1    
::call :run "%eDIR%\padding.vbs" && goto :success || goto :failed
