...
function main()
  ...
  test 1, deep, split("1"  , ";")   , 1
  test 2, deep, split("1;2", ";")   , 2
  test 3, deep, array(1, true, "")  , 3
  test 4, deep, array(1,2)          , 2
  test 5, deep, array()             , 0
  test 6, deep, toArrayList("1")    , 1
  test 7, deep, toArrayList("1;2")  , 2
  test 8, deep, toArrayList("")     , 0
