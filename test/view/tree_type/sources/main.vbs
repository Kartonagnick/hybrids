...
'--- local/hybrids                              [test][view/tree_type][main.vbs]
...
sub check(id, value, expect)
  dim result: dim out: set out = new TreeType
  set result = out.getText(value)
...
'---
  ...
  if gMY_TEST = true then
   'echo deep, "[SUCCESS] view/tree_type"
  else
    echo deep, "[ERROR] view/tree_type"
    WScript.Quit 1
  end if
end function
