...
'--- local/hybrids                             [test][view/tree_debug][main.vbs]
'[2024-04-13][19:00:00] 001 Kartonagnick PRE
'
'checked containers:
'      value = Array
...
sub check(id, value, expect)
  dim result: dim out: set out = new TreeDebug
  set result = out.getText(value)
...
'---
  ...
  if gMY_TEST = true then
   'echo deep, "[SUCCESS] view/tree_debug"
  else
    echo deep, "[ERROR] view/tree_debug"
    WScript.Quit 1
  end if
end function
