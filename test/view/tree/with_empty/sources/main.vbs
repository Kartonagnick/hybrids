...
'--- local/hybrids                             [test][tree/with_empty][main.vbs]
...
sub check(id, value, expect)
  dim result: dim out: set out = (new Tree)(true, false)
  set result = out.getText(value)
...
'---
  ...
  if gMY_TEST = true then
   'echo deep, "[SUCCESS] tree/with_empty"
  else
    echo deep, "[ERROR] tree/with_empty"
    WScript.Quit 1
  end if
end function
