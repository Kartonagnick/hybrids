...
'--- local/hybrids                              [test][tree/with_type][main.vbs]
...
sub check(id, value, expect)
  dim result: dim out: set out = (new Tree)(false, true)
  set result = out.getText(value)
...
'---
  ...
  if gMY_TEST = true then
   'echo deep, "[SUCCESS] tree/with_type"
  else
    echo deep, "[ERROR] tree/with_type"
    WScript.Quit 1
  end if
end function
