...
sub main()
  ...
  eq_compare deep, 1, obj.stamp, "2021-08-25 12:23:45.123"

  set obj = new DTStamp
  obj.date = "2021-08m-25 12:23:45.123"
  eq_compare deep, 2, obj.stamp, "2021-08-25 12:23:45.123"

  set obj = new DTStamp
  obj.date = "2021y-08m-25d 12:23:45.123"
  eq_compare deep, 3, obj.stamp, "2021-08-25 12:23:45.123"

  if gMY_TEST = true then
   'echo deep, "[SUCCESS] DTStamp usage-workspace"
  else
