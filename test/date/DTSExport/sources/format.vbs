...
'--- other DTSImport
  set ext = new DTSExport             : eq_compare deep, 7, ext.format, "YY-MM-DD hh:mm:ss.ms"
  set ext.format = obj                : eq_compare deep, 8, ext.format, "hh:mm:ss.ms YY|MM|DD"

'--- Null/Nothing/empty
  set obj = new DTSExport: obj.format = Null   : eq_compare deep,  9, obj.format, "YY-MM-DD hh:mm:ss.ms"
  set obj = new DTSExport: obj.format = Nothing: eq_compare deep, 10, obj.format, "YY-MM-DD hh:mm:ss.ms"
  set obj = new DTSExport: obj.format = Empty  : eq_compare deep, 11, obj.format, "YY-MM-DD hh:mm:ss.ms"
