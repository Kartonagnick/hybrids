...
function main()
  ...
  test 16, deep, errorNotExist        , "errorNotExist"
  test 17, deep, errorLogick          , "errorLogick"
  test 18, deep, errorLogick + 1      , "errorUnknown"
  test 19, deep, errorLogick + 10     , "errorUnknown"
  test 20, deep, errorLogick + 100    , "errorUnknown"

  if gMY_TEST = true then
   'echo deep, "[SUCCESS] errCode"
  else
