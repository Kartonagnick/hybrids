...
rem --- local/hybrids                                   [eolcode/test-[vbs].bat]
rem [2026-03-26][19:20:00] 001 Kartonagnick PRE
rem ============================================================================
rem ============================================================================
...
::chcp 65001 >nul
  ...
  set "eDEBUG=ON"
  set "eDIR_WORK=C:\repo\Bolid\_stash\main"
  set "eDIR_WORK=C:\repo\Bolid\main\3dparty\nuklear"
  set "eDIR_WORK=C:\Bolid\Idrisov\Banana.props"
