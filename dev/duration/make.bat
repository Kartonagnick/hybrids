...
rem --- local/hybrids                                        [duration/make.bat]
rem [2026-02-19][14:30:00] 001 Kartonagnick PRE
rem ============================================================================
rem ============================================================================
...
::set "eDEBUG=ON"
  ...
  set "eHYBRID.STAMP=[2026-02-19][14:30:00]"
  set "eHYBRID.PRE=PRE"
  set "eHYBRID.PROJECT=local/hybrids"
  set "eHYBRID.FILE=[script][duration.bat]"
