...
rem --- local/hybrids                                        [diffdate/make.bat]
rem [2026-01-28][15:40:00] 001 Kartonagnick PRE
rem ============================================================================
rem ============================================================================
...
::set "eDEBUG=ON"
  ...
  set "eHYBRID.STAMP=[2026-01-28][15:40:00]"
  set "eHYBRID.PRE=PRE"
  set "eHYBRID.PROJECT=local/hybrids"
  set "eHYBRID.FILE=[script][diffdate.bat]"
