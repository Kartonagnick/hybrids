...
1. upd: `docs`  
   - upd: `logo.png`       (053) PRE  
   - upd: `changelog.md`   (053) PRE  
   - upd: `history.md`     (053) PRE  
   - upd: `chrono.md`      (053) PRE  
   - upd: `docs.md`        (053) PRE  
2. upd: `docs/docs`  
   - upd: `date.md`        (002) PRE  
3. add: `docs/docs/date`  
   - add: `elapsed.md`     (001) PRE  
4. upd: `test`  
   - upd: `test.ver`       (050) PRE  
...
7. upd: `vbs`  
   - upd: `vbs.ver`        (038) PRE  
8. add: `vbs/date`  
   - add: `elapsed.vbs`    (001) PRE  
9. upd: `project.root`     (053) PRE  
