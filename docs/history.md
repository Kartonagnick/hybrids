...
3. add: `docs/workflow`  
   ...
   - add: `requirements.md` (001) PRE  
4. add: `docs/workflow/requirements`
   - add: `ignore.md`       (001) PRE  
   - add: `git-config.md`   (001) PRE  
   - add: `eol-encoding.md` (001) PRE  
   - add: `eol-Alice.md`    (001) PRE  
3. add: `project.root`      (001) PRE  
4. add: `.gitlab-ci.yml`    (001) PRE  
5. add: `.gitignore`        (001) PRE  
6. add: `.editorconfig`     (001) PRE  
6. add: `.gitattributes`    (001) PRE  
6. add: `.gitconfig`        (001) PRE  
6. upd: `.gitignore`        (001) PRE  
6. fix: `README.md`  
7. add: `LICENSE`  
