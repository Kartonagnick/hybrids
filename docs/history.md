...
5. add: `dev/vsscan/sources`  
   - add: `vsscan.vbs`      001  
   - add: `struct.txt`      001  
   - add: `solution.vbs`    001  
   - add: `settings.vbs`    001  
   - add: `project.vbs`     001  
6. upd: `project.root`      068  
...
7. add: `test/fcontent/sources/resources/isbin`  
   ...
   - add: `enca.zzz`  
   - add: `enca.exe`  
8. add: `test/fcontent/sources/resources/valid`  
   - add: `text-utf8-lf.txt`  
   - add: `text-utf8-crlf.txt`  
   - add: `text-ansi-lf.txt`  
   - add: `text-ansi-crlf.txt`  
...
6. add: `test/date/duration/sources`  
   ...
   - add: `durationFromSeconds_RU.vbs`  001  
   - add: `durationFromMS_RU.vbs`       001  
   - add: `durationFrom_RU.vbs`         001  
7. upd: `vbs`  
   - upd: `vbs.ver`                     035  
8. add: `vbs/date`  
   - add: `duration.vbs`                002  
   - add: `durationRU.vbs`              002  
...
3. add: `docs/workflow`  
   - add: `notation.md`      001  
   - add: `requirements.md`  001  
4. add: `docs/workflow/requirements`
   - add: `ignore.md`        001  
   - add: `git-config.md`    001  
   - add: `eol-encoding.md`  001  
   - add: `eol-Alice.md`     001  
3. add: `project.root`       001  
4. add: `.gitlab-ci.yml`     001  
5. add: `.gitignore`         001  
6. add: `.editorconfig`      001  
7. add: `.gitattributes`     001  
8. add: `.gitconfig`         001  
9. upd: `.gitignore`         001  
10. fix: `README.md`  
11. add: `LICENSE`  
