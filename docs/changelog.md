...
[VE070]: history.md#-v070-dev

|    дата    | время |       ветка       |    статус     |  
|:----------:|:-----:|:-----------------:|:-------------:|  
| 2026-03-26 | 19:20 | [#70-dev-eolcode] | [![V]][VE070] |  

Добавлен гибрид: `ready/eolcode.bat`  
 - сканирует репозиторий  
 - выявляет нарушения кодировки и EOL  
<br/>
...
[VE069]: history.md#-v069-dev

|    дата    | время |       ветка        |    статус     |  
|:----------:|:-----:|:------------------:|:-------------:|  
| 2026-02-19 | 14:30 | [#69-dev-duration] | [![V]][VE069] |  

Добавлен гибрид: `ready/duration.bat`  
 - сканирует каталог  
 - находит маркдаун файлы  
 - находит в файлах фрагменты текста, 
   которые определяют длительность выполнения задачи  
 - прописывает правильное значение длительности 
   в течении которого выполнялась задачи  
<br/>
...
[VE068]: history.md#-v068-dev

|    дата    | время |      ветка       |    статус     |  
|:----------:|:-----:|:----------------:|:-------------:|  
| 2026-01-30 | 11:50 | [#68-dev-vsscan] | [![V]][VE068] |  

Добавлен гибрид: `ready/vsscan.bat`  
 - сканирует банановый репозиторий  
 - находит солюшены  
 - находит проекты  
 - формирует списки исходников  
<br/>
...
[VE067]: history.md#-v067-dev

|    дата    | время |     ветка      |    статус     |  
|:----------:|:-----:|:--------------:|:-------------:|  
| 2026-01-29 | 19:30 | [#67-dev-logg] | [![V]][VE067] |  

Добавлена возможность перенаправить вывод
как в консоль, так и в файл: `vbs/logging.vbs`  
<br/>
...
[VE066]: history.md#-v066-dev

|    дата    | время |     ветка      |    статус     |  
|:----------:|:-----:|:--------------:|:-------------:|  
| 2026-01-28 | 18:10 | [#66-dev-util] | [![V]][VE066] |  

Добавлена функция: `vbs/unquote.vbs`  
<br/>
...
[VE065]: history.md#-v065-dev

|    дата    | время |        ветка       |    статус     |  
|:----------:|:-----:|:------------------:|:-------------:|  
| 2026-01-28 | 15:40 | [#65-dev-diffdate] | [![V]][VE065] |  

Добавлен гибрид: `ready/diffdate.bat`  
  - предназначен для определения длительности периода между двумя датами  
<br/>
...
[VE063]: history.md#-v063-dev

|    дата    | время |      ветка      |    статус     |  
|:----------:|:-----:|:---------------:|:-------------:|  
| 2025-01-15 | 23:50 | [#63-dev-strip] | [![V]][VE063] |  

Добавлены функции удаления части текста сначала или с конца:  
...
[VE062]: history.md#-v062-dev

|    дата    | время |       ветка      |    статус     |  
|:----------:|:-----:|:----------------:|:-------------:|  
| 2025-01-15 | 19:00 | [#62-dev-badgen] | [![V]][VE062] |  

Добавлен инструмент `badgen`  
Сканирует `*.md` файлы, и устанавливает стиль ссылок-бейджиков.  
<br/>
...
Добавлен инструмент `FileContent`  
